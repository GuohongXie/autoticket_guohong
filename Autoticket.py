...
class Concert(object):
    ...
    def choose_ticket_1(self):  # for type 1, i.e., detail.damai.cn
        ...
        while self.driver.title.find('确认订单') == -1:  # 如果跳转到了确认界面就算这步成功了，否则继续执行此步
            ...
            price_list = price.find_elements_by_class_name('select_right_list')
            ...
            if buybutton_text == "即将开抢" or buybutton_text == "即将开售":
                ...
                #self.driver.get(con.target_url)
                self.driver.refresh()
                continue
...
if __name__ == '__main__':
    ...
    #定时抢票
    import datetime
    startTime = datetime.datetime(2021, 3, 26, 17, 58, 10)  #定时功能：2021-3-26 17:58:10秒开抢
    print('抢票程序还未开始...')
